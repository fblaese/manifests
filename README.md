...
wget https://raw.githubusercontent.com/rn3-los15/manifests/lineage-15.1/rom.xml -O .repo/local_manifests/rom.xml
repo sync -c --no-tags --no-clone-bundle --force-sync -j4
wget https://raw.githubusercontent.com/rn3-los15/manifests/lineage-15.1/clean-build.sh && chmod a+x clean-build.sh && wget https://raw.githubusercontent.com/rn3-los15/manifests/lineage-15.1/dirty-build.sh && chmod a+x dirty-build.sh
