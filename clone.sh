...
git clone --depth=1 https://github.com/AmolAmrit/android_hardware_cyanogen -b oreo hardware/cyanogen
rm -rf hardware/qcom/audio-caf/msm8952
rm -rf hardware/qcom/display-caf/msm8952
rm -rf hardware/qcom/media-caf/msm8952
git clone --depth=1 https://github.com/Cardinal-AOSP/hardware_qcom_audio -b oreo-caf-8952 hardware/qcom/audio-caf/msm8952
git clone --depth=1 https://github.com/Cardinal-AOSP/hardware_qcom_media -b oreo-caf-8952 hardware/qcom/media-caf/msm8952
